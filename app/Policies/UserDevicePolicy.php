...
class UserDevicePolicy
{
    ...
    {
        return $user->can('view_any_users::user::device');
    }
    ...
    {
        return $user->can('view_users::user::device');
    }
    ...
    {
        return $user->can('create_users::user::device');
    }
    ...
    {
        return $user->can('update_users::user::device');
    }
    ...
    {
        return $user->can('delete_users::user::device');
    }
