...
class WorkPatternPolicy
{
    ...
    {
        return $user->can('view_any_work::patterns::work::pattern');
    }
    ...
    {
        return $user->can('view_work::patterns::work::pattern');
    }
    ...
    {
        return $user->can('create_work::patterns::work::pattern');
    }
    ...
    {
        return $user->can('update_work::patterns::work::pattern');
    }
    ...
    {
        return $user->can('delete_work::patterns::work::pattern');
    }
     ...
     */
    public function replicate(User $user, WorkPattern $workPattern): bool
    {
