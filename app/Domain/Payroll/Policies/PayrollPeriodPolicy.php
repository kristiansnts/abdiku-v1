...
class PayrollPeriodPolicy
{
    ...
    {
        return $user->can('view_any_payroll::payroll::period');
    }
    ...
    {
        return $user->can('view_payroll::payroll::period');
    }
    ...
    {
        return $user->can('create_payroll::payroll::period');
    }
    ...
    {
        return $user->can('update_payroll::payroll::period');
    }
    ...
    {
        return $user->can('delete_payroll::payroll::period');
    }
