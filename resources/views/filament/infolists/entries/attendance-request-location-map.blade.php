@php
    $record = $getRecord();
    $companyLocation = $record->attendanceRaw?->companyLocation;
    $latitude = $companyLocation?->latitude ?? -6.2297;
    $longitude = $companyLocation?->longitude ?? 106.8164;
    $radius = $companyLocation?->geofence_radius_meters ?? 100;
@endphp
